...
//               $("#windspeed_range").data("ionRangeSlider").result.from,
...
//               $("#windspeed_range").data("ionRangeSlider").result.to,
...
//     .data("ionRangeSlider")
//     .update({
//       from: $("#windspeed_range").data("ionRangeSlider").result.from,
//       to: $("#windspeed_range").data("ionRangeSlider").result.to,
//     });
...
//     if (
//       ($("#windspeed_range").data("ionRangeSlider").options.from != min[3]) |
//       ($("#windspeed_range").data("ionRangeSlider").options.to != max[3])
//     ) {
//       $("#windspeed_range").data("ionRangeSlider").update({
//         type: "double",
//         min: 0,
//         max: 10,
//         from: min[3],
